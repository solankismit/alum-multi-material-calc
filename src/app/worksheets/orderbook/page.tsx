...
import PrintableWithShare from "./PrintableWithShare";
import OrderbookWhatsAppButton from "./OrderbookWhatsAppButton";
...
export default async function OrderbookPage({ searchParams }: OrderbookParams) {
    ...
    return (
        <div className="min-h-screen bg-surface-muted px-4 sm:px-6 lg:px-8 py-4 md:py-8 font-sans print:bg-white print:p-0">
            ...
            <PrintableWithShare filename="Orderbook-Summary.pdf">
                <div className="max-w-7xl print:max-w-5xl mx-auto space-y-6 md:space-y-8">
                {/* Header Actions */}
